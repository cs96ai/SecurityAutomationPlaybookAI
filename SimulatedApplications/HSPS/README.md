# HSPS - Cybersecurity Monitoring Demo

A comprehensive Kubernetes-based cybersecurity monitoring demonstration for the Health Systems Pharmacy System (HSPS) with simulated applications that emit security-relevant telemetry data.
